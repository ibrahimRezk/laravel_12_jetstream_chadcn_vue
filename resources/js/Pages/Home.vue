...
<template>
    <div id="app" class="bg-gray-50">
        ...
        <section
            id="home"
            class="relative pt-16  text-white min-h-screen flex items-center
            bg-white   bg-cover bg-center bg-fixed overflow-hidden"
        ...
        <section class="py-16 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                    <div class="md:flex">
                        <div class="md:w-1/2 p-8 md:p-12 slide-right-element border rounded-l-2xl border-gray-800/20">
                            <h2
                        ...
                        <div
                            class="md:w-1/2 bg-gradient-to-br from-zinc-800/10 to-secondary/10 flex items-center justify-center p-12 slide-left-element"
                        >
                            <div
        ...
        <!-- Services Section -->
        <section id="services" class="   relative bg-cover bg-center bg-fixed overflow-hidden" style="background-image: url('assets/img/24203.jpg');">
            <div class=" bg-indigo-600/50 relative bg-cover bg-center bg-fixed overflow-hidden ">
        ...
        <section id="doctors" class="py-20 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    >
                        <div
                            class="h-64 bg-gradient-to-br from-zinc-800/20 to-secondary/20 flex items-center justify-center"
                        >
                            <div
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div
                        ...
                        :key="testimonial.id"
                        class="bg-gray-50 rounded-xl p-8 card-hover slide-up-element"
                    >
                        <div class="flex mb-4">
                            <span
                                v-for="star in 5"
